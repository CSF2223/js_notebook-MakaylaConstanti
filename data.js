...
/* ARRAYS: */
const newEngland = ["New Hampshire", "Vermont", "Maine", "Massachusetts", "Rhode Island", "Connscticut"];
...
newEngland.indexOf("Rhode Island", 0);      // Search the array for an element and return its 
